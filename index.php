...
<html>
   <head>
      ...
      <!-- site metas -->
      <title>NU GO - An Event Management System of NU Baliwag</title>
   ...
   <body>
                  ...
                  <div class="carousel-inner">
                        ...
                        <div class="row">
                           <div class="col-md-5">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Event Management Mobile App</h1>
                     ...
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-md-5">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Facility Reservation Mobile App</h1>
                                 <div class="started_text"><a href="#">Read More</a></div>
                              </div>
                           </div>
                           <div class="col-md-7">
                     ...
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-md-5">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Org Management Mobile App</h1>
                                 <div class="started_text"><a href="#">Read More</a></div>
                              </div>
                           </div>
                           <div class="col-md-7">
      ...
      <div class="apps_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <div class="apps_img"><img src="images/app-img.png"></div>
               </div>
               <div class="col-md-6">
      ...
      <!-- <div class="pricing_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="pricing_taital">PRICING PLAN</h1>
                  <p class="pricing_text">Readable content of a page when looking at its layout. The point of </p>
               </div>
            </div>
                  ...
                  <div class="col-md-4">
                     <div class="pricing_box">
                        <div class="taital_main">
                           ...
                           <h1 class="dolor_text_1">33</h1>
                           <p class="month_text">/Per Month</p>
                        </div>
                        <h6 class="regular_text">Regular</h6>
                        <p class="using_text">which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything</p>
                     </div>
      ...
      <div class="customer_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="customer_taital">Customers Review</h1>
               </div>
            </div>
         </div>
